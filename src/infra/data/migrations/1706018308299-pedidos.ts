...
export class Pedidos1706018308299 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "pedidos" ("id" SERIAL NOT NULL, "codigoPedido" integer NOT NULL, "cpfCliente" character varying NOT NULL, "precoTotal" integer NOT NULL, "dataHoraCadastro" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ebb5680ed29a24efdc586846725" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
